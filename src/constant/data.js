...
export const useCasesData = [
  {
    heading: "Offsites & Retreats",
    description: "Keep attendance and logistics tidy.",
  },
  {
    heading: "Department Mixers",
    description: "Let employees from different teams connect effortlessly.",
  },
  {
    heading: "Holiday Parties & Celebrations",
    description:
      "Invite everyone with a single link; handle travel funds easily.",
  },
  {
    heading: "New Hire Welcome",
    description: "Match new employees with mentors for quicker onboarding.",
  },
];
